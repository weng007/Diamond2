...
//{
    public class SQLHelper : IDisposable
    {
        ...
        const string appName = "Diamond Shop";
        ...
        public DataSet FillDataSetBySP4(string sql, DataSet ds, params SqlParameter[] parameters)
        {
            if (ds.Tables.Count == 0)
            {
                ds.Tables.Add();
            }
            return FillDataSetBySP2(sql, ds, parameters);
        }
        ...
        public int ExecuteSP(string spName, DataRow row)
        {
            ...
            try
            {
                ...
                ////SqlCommand comm = new SqlCommand(spName, connection, tran);
                comm = new SqlCommand(spName, connection, tran);
                comm.CommandType = CommandType.StoredProcedure;
                comm.CommandTimeout = commandTimeOut;
