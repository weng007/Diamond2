...
{
    public partial class BuyBookDiamonCrExcel : FormInfo
    {
        ...
        public BuyBookDiamonCrExcel()
        {
            InitializeComponent();
            Initial();
        }

        public BuyBookDiamonCrExcel(int id,string FilePath)
        {
            InitializeComponent();
            Initial();
        ...
        {
            ExcelService.GetExcel(FilePath);

            base.LoadData();
        }
        private void BindDTGridView()
        {
