...
{
    public partial class WarningTransferList : FormList
    {     
        public WarningTransferList()
        {
            InitializeComponent();
            Initial();
            DoLoadData();
