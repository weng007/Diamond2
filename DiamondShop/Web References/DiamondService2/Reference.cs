...
namespace DiamondShop.DiamondService2 {
    ...
    public partial class Service3 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataSet DoSearchCatalog(string code) {
        ...
        /// <remarks/>
        public void DoSearchCatalogAsync(string code) {
            this.DoSearchCatalogAsync(code, null);
        }
        
        /// <remarks/>
        public void DoSearchCatalogAsync(string code, object userState) {
            ...
            this.InvokeAsync("DoSearchCatalog", new object[] {
                        code}, this.DoSearchCatalogOperationCompleted, userState);
        }
        ...
        public System.Data.DataSet DoSearchDiamondCer(string reportNumber, int shape, int lab, double sWeight, double eWeight, int sColor, int eColor, int sClearity, int eClearity, int status, int shop) {
        ...
        /// <remarks/>
        public void DoSearchDiamondCerAsync(string reportNumber, int shape, int lab, double sWeight, double eWeight, int sColor, int eColor, int sClearity, int eClearity, int status, int shop) {
            this.DoSearchDiamondCerAsync(reportNumber, shape, lab, sWeight, eWeight, sColor, eColor, sClearity, eClearity, status, shop, null);
        }
        
        /// <remarks/>
        public void DoSearchDiamondCerAsync(string reportNumber, int shape, int lab, double sWeight, double eWeight, int sColor, int eColor, int sClearity, int eClearity, int status, int shop, object userState) {
            ...
            this.InvokeAsync("DoSearchDiamondCer", new object[] {
                        ...
                        eClearity,
                        status,
                        shop}, this.DoSearchDiamondCerOperationCompleted, userState);
        }
        ...
        public System.Data.DataSet DoSearchGemstoneCer(int identification, string code, string reportnumber, double sweight, double eweight, int shape, int comment, int lab, int origin, int status, int shop) {
        ...
        /// <remarks/>
        public void DoSearchGemstoneCerAsync(int identification, string code, string reportnumber, double sweight, double eweight, int shape, int comment, int lab, int origin, int status, int shop) {
            this.DoSearchGemstoneCerAsync(identification, code, reportnumber, sweight, eweight, shape, comment, lab, origin, status, shop, null);
        }
        
        /// <remarks/>
        public void DoSearchGemstoneCerAsync(int identification, string code, string reportnumber, double sweight, double eweight, int shape, int comment, int lab, int origin, int status, int shop, object userState) {
            ...
            this.InvokeAsync("DoSearchGemstoneCer", new object[] {
                        ...
                        origin,
                        status,
                        shop}, this.DoSearchGemstoneCerOperationCompleted, userState);
        }
